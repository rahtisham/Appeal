                    ...
                    <div class="media wow fadeInUp" data-wow-duration="1s">
                        ...
                        <div class="media-body">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-6 card" style="border-radius: 5px; padding: 10px;">
                                        <div class="panel panel-primary p-3">
                                            <h3>Authorize Payment Method</h3>
...
{{--                                                                <span id="amount-error" class="error text-red">Please enter amount</span>--}}
                                                        ...
                                                        <div class="form-group" id="pay-now">
                                                            <button type="submit" class="btn btn-success themeButton" id="confirm-purchase">PAYMENT</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
