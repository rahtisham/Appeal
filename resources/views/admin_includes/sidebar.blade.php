        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ route('subscription_plan.index') }}" class="ai-icon" aria-expanded="false">
                            <i class="fa fa-usd" aria-hidden="true"></i>
                            <span class="nav-text">Widget</span>
                        </a>
                    </li>
                    <li><a href="{{ route('profile.setting') }}" class="ai-icon" aria-expanded="false">
				...
				<div class="add-menu-sidebar">
					<img src="{{ asset('admin_assets/images/icon1.png') }}" alt=""/>
