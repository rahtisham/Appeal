...
@section('title', 'Walmart Email Alert')
                                                        ...
                                                        <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td class="res-center" style="text-align: center; color: white; font-family: 'Raleway', Arial, Sans-serif; font-size: 35px; letter-spacing: 3px; word-break: break-word; font-weight: 800; padding-left: 3px;" data-color="M1 Title 2" data-size="M1 Title 2" data-max="45" data-min="25">
                                                                    <a CLASS="btn btn-danger" target="_blank" href="https://www.walmart.com/ip/{{ $walmart_amail_alert_view['product_url'] }}">PRODUCT LINK</a>
                                                                </td>
                                                            </tr>
                                                            <!-- title end -->
                                                            <tr>
                                                        ...
                                                        <td><br><br>
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tr>
                                                                    <th scope="col">SKU</th>
                                                                    <td>
                                                                        {{ $walmart_amail_alert_view['sku'] }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="col">STATUS</th>
                                                                    <td>
                                                                        {{ $walmart_amail_alert_view['status'] }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="col">PRODUCT NAME</th>
                                                                    <td>
                                                                        {{ $walmart_amail_alert_view['product_name'] }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="col">UNPUBLISHED REASON</th>
                                                                    <td>
                                                                        {{ $walmart_amail_alert_view['reason'] }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="col">PRODUCT TYPE</th>
                                                                    <td>
                                                                        {{ $walmart_amail_alert_view['alert_type'] }}
                                                                    </td>
                                                                </tr>
                                                                </thead>
                                                            </table>
